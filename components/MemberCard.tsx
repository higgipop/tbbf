...
export default function MemberCard({ member }: { member: Member }) {
  return (
    <Link
      ...
      className="group bg-white rounded-xl p-6 shadow-sm border border-black/6 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 flex flex-col items-center text-center gap-4"
    >
